 ...
 * @access public
 */
class HC4_App_WordPress_Pro_UpdateChecker
{
...
// echo "HC3 PRO UPDATE CHECKER<br>$url<br>";
// exit;
// }
		...
		if ( !is_wp_error($result) && isset($result['response']['code']) && ($result['response']['code'] == 200) && !empty($result['body']) ){
			$pluginInfo = HC4_Pro_UpdateChecker_PluginInfo::fromJson($result['body'], $this->debugMode);
	...
	public function requestUpdate(){
		...
		return HC4_Pro_UpdateChecker_PluginUpdate::fromPluginInfo($pluginInfo);
	}
	...
	public function getUpdateState() {
		...
		if ( !empty($state) && isset($state->update) && is_object($state->update) ){
			$state->update = HC4_Pro_UpdateChecker_PluginUpdate::fromObject($state->update);
		}
		return $state;
	}
 ...
 * @access public
 */
class HC4_Pro_UpdateChecker_PluginInfo {
 ...
 * @access public
 */
class HC4_Pro_UpdateChecker_PluginUpdate {
	public $id = 0;
	public $slug;
	public $version;
	public $homepage;
	...
	public static function fromJson($json, $triggerErrors = false){
		...
		$pluginInfo = HC4_Pro_UpdateChecker_PluginInfo::fromJson($json, $triggerErrors);
		if ( $pluginInfo != null ) {
