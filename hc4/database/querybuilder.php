...
class HC4_Database_QueryBuilder
{
	...
	public function get_compiled_insert_batch( $table = '', $set = NULL )
	{
		$return = array();
		$batchSize = 100;
	...
	{
		return str_replace("'", "''", HC4_App_Functions::removeInvisibleCharacters($str));
	}
