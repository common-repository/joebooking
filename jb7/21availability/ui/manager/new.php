...
class JB7_21Availability_Ui_Manager_New
{
...
<form method="post" action="HREFPOST:{CURRENT}">
	...
	<div class="hc4-form-elements">
		...
		<div class="hc-grid">
			<div class="hc-col hc-col-4">
				<div class="hc4-form-element">
					...
					<?php echo $this->inputTime->render( 'start_time', 9 * 60 * 60 ); ?>
				</div>
			</div>
			...
			<div class="hc-col hc-col-4">
				<div class="hc4-form-element">
					...
					<?php echo $this->inputTime->render( 'end_time', 18 * 60 * 60 ); ?>
				</div>
			</div>
			...
			<div class="hc-col hc-col-4">
				<div class="hc4-form-element">
					...
					<?php echo $this->inputDuration->render( 'interval', 30 * 60 ); ?>
				</div>
			</div>
		</div>
		...
		<div class="hc4-form-element">
			...
			<?php echo $this->inputRadioSet->render( 'priority', $priorityOptions, 2 ); ?>
			<em>
